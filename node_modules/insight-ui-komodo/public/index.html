...
<head>
  <base href="/" />
	...
	<title data-ng-if="currency.testnet" data-ng-bind="$root.title + $root.titleDetail + ' | Testnet Insight'">PIRATE Explorer</title>
	<title data-ng-if="!currency.testnet" data-ng-bind="$root.title + $root.titleDetail + ' | Insight'">PIRATE Explorer</title>
