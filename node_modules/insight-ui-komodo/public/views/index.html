...
<coingecko-coin-ticker-widget  coin-id="pirate-chain" currency="usd" locale="en" background-color="#c0c0c0"></coingecko-coin-ticker-widget>
        ...
        <p class="subIntro">Pirate (ARRR) is a real privacy coin who take financial privacy very serious.
Pirate (ARRR) is a 100% private send cryptocurrency. PIRATE uses a privacy protocol that cannot be compromised by other users activity on the network.</p>
<p class="subIntro">Basic Statistics at  <a href="https://explorer.pirate.black/stats" target="_blank"><font color="#ff5050">https://explorer.pirate.black/stats</font></a></p>

        <p class="subIntro">Buy a small bag or ARRR on <a href="https://pirate.dexstats.info" target="_blank"><font color="#ff5050">PIRATE onboarding here</font></a> and get up to 10% on referral.
 <p class="subIntro">Pirate Website <a href="https://pirate.black"  target="_blank"> <font color="#ff5050">https://pirate.black</font></a></p>
        <p data-ng-if='currency.testnet'><strong>This explorer is showing the live PIRATE network! Yes there is not much to see because it's so private</strong></p>
